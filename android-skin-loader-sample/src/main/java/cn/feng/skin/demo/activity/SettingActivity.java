...
public class SettingActivity extends BaseActivity {
	...
	private static final String SKIN_DIR_BLACK = Environment
			.getExternalStorageDirectory() + File.separator + "blackNight.skin";
	
	
	private TextView titleText;
	private Button setOfficalSkinBtn;
	private Button setNightSkinBtn;
	private Button setBlackSkinBtn;
	...
	private void initView() {
		...
		setBlackSkinBtn = (Button) findViewById(R.id.set_black_skin);
		...
		setBlackSkinBtn.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				setBlackSkin();
			}
	...
	private void setBlackSkin() {
		...
		File skin = new File(SKIN_DIR_BLACK);

		if(skin == null || !skin.exists()){
			Toast.makeText(getApplicationContext(), "请检查" + SKIN_DIR_BLACK + "是否存在", Toast.LENGTH_SHORT).show();
			return;
		}
		...
		SkinManager.getInstance().load(skin.getAbsolutePath(),
				new ILoaderListener() {
					...
					public void onSuccess() {
						...
						setBlackSkinBtn.setText("红色默认(当前)");
						setNightSkinBtn.setText("黑色幻想");
						setOfficalSkinBtn.setText("官方默认");
